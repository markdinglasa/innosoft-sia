        ...
        <AppBar position="static" elevation={0}>
            <StyledToolbar variant="dense">
                <Stack direction="row" spacing={2} alignItems="center">
                   ...
                   <div onClick={()=>navigate(POSPages.DASHBOARD)} className="cursor-pointer flex items-center justify-center">
                ...
                <Stack direction="row" spacing={1.5} alignItems="center">
                    ...
                    <Stack direction="row" spacing={1.5}>     
                        <CircleButton icon={<PrinterIcon sx={{ fontSize: 25, color: colors.white }} titleAccess="Printer Online" />} type={ButtonType.button} color={ButtonColor.blue} onClick={()=>{}}/>
                        <CircleButton icon={<ScannerIcon sx={{ fontSize: 25, color: colors.white }} titleAccess="Scanner Ready" />} type={ButtonType.button} color={ButtonColor.blue} onClick={()=>{}}/>
                        <CircleButton icon={<NotificationsIcon sx={{ fontSize: 25, color: colors.white }} titleAccess="Notifications" />} type={ButtonType.button} color={ButtonColor.blue} onClick={()=>navigate(POSPages.NOTIFICATIONS)}/>
                    </Stack>
                    <ProfileDropdown/> 
                </Stack>
            </StyledToolbar>
