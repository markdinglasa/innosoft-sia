        ...
        return (
            <Box className="flex h-screen w-full flex-col items-center justify-center p-8 text-center bg-gray-100">
                ...
                <Typography variant="body1" sx={{ color: 'text.secondary', mb: 4 }}>
                    You do not have the necessary permissions to view this screen. 
                    Please return to your designated workspace or request manager override.
                </Typography>
                <Button 
                    variant="outlined" 
                    size="large" 
