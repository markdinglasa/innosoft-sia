...
export const PayTypeList: React.FC = () => {
  ...
  const canEdit = hasPermission(SystemPermissions.PAY_TYPE_EDIT)
  const canDelete = hasPermission(SystemPermissions.PAY_TYPE_REMOVE)
  ...
  return (
    <>
              ...
              {items.map((item: any) => (
                <TableRow
                  ...
                  onClick={() => {
                    if (!canEdit) {
                      displayToast(
                        'You do not have permission to edit this pay type.',
                        ToastType.info
                      )
                      return
                    }
      ...
      <Dialog open={deleteId !== null} onClose={() => setDeleteId(null)}>
        ...
        <DialogContent>
          <DialogContentText>Delete this pay type? This cannot be undone.</DialogContentText>
        </DialogContent>
        <DialogActions>
