...
export const PeriodList: React.FC = () => {
  ...
  const canEdit = hasPermission(SystemPermissions.PERIOD_EDIT)
  const canDelete = hasPermission(SystemPermissions.PERIOD_REMOVE)
  ...
  return (
    <>
          ...
          <TableBody>
            <TableSkeleton isLoading={isLoading} columns={4} rows={15}>
              {items.map((item: any) => (
                ...
                >
                  <TableCell>
                    <PeriodIcon color="primary" sx={{ fontSize: 25 }} />
                  </TableCell>
                  <TableCell>
      ...
      <Dialog open={deleteId !== null} onClose={() => setDeleteId(null)}>
        ...
        <DialogContent>
          <DialogContentText>Delete this period? This cannot be undone.</DialogContentText>
        </DialogContent>
        <DialogActions>
