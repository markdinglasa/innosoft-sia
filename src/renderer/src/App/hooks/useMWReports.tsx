...
export const useMWReports = (path: string, tenant: Tenant, Dates: string) => {
  ...
  const createReport = useCallback(async () => {
    try {
      ...
      const VATAmountResponse = await window.electron.sql.get(SqlChannel.getAmount, VATAmountQuery)
      ...
      const PaymentSalesReponse = await window.electron.sql.get(SqlChannel.getAmount, PaymentSalesQ)
