export enum POSEntity {
  ...
  TRN_PURCHASE_ORDER_APPROVAL = 'TrnPurchaseOrderApproval',
  TRN_PURCHASE_ORDER_RECEIVING = 'TrnPurchaseOrderReceiving',
  TRN_PURCHASE_ORDER_RECEIVING_LINE = 'TrnPurchaseOrderReceivingLine',
  MST_SUPPLIER_CATALOG = 'MstSupplierCatalog',
  TRN_ORDER = 'TrnOrder',
